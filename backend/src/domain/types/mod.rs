...
pub use extensions::{
    ...
    EXT_BRANCH_ID, EXT_CANDIDATE_RANKING, EXT_CONSECUTIVE_NO_IMPROVEMENT,
    EXT_CURRENT_PROMPT_STATS, EXT_DIVERSITY_ANALYSIS, EXT_EVALUATIONS_BY_TEST_CASE_ID,
    EXT_FAILURE_ARCHIVE, EXT_PREV_ITERATION_STATE, EXT_RECENT_PRIMARY_SCORES, EXT_TASK_MODE,
