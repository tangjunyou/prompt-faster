...
#[openapi(
    ...
    components(
        schemas(
            ...
            crate::domain::models::PromptPreviewRequest,
            crate::domain::models::PromptPreviewResult,
            crate::domain::models::PromptPreviewResponse,
            crate::domain::models::PromptValidationRequest,
            crate::domain::models::PromptValidationResult,
