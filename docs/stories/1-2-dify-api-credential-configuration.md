...
- [x] **Task 4: 对齐架构的 api-config Feature 对外接口** (AC: #1, #2)
  ...
  - [x] 4.2 创建 `frontend/src/features/api-config/ApiConfigPanel.tsx`（作为该 feature 的对外入口，对齐 `docs/architecture.md` 规划）
...
> - 目录结构：遵循 `features/api-config/` 模式，并对齐 `docs/architecture.md` 的对外入口命名（`ApiConfigPanel.tsx`）
...
- [Source: docs/architecture.md#Frontend-Architecture] - 前端架构设计
- [Source: docs/architecture.md#State-Management] - 状态管理策略
- [Source: docs/epics.md#Story-1.2] - 验收标准原文
- [Source: docs/prd.md#7.3] - 前端架构要求
