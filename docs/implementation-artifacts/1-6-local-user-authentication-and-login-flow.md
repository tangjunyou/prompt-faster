...
- `docs/project-planning-artifacts/architecture.md` 的规划结构中包含 `domain/models/user.rs`，但当前代码库尚未落地，实现时需以仓库现状为准创建文件，避免误判“已存在”。
...
- [Source: docs/project-planning-artifacts/epics.md#Story-1.6] - 验收标准原文
...
- [Source: docs/project-planning-artifacts/architecture.md#Authentication-&-Security] - Argon2 + AES-GCM + 密钥仅存内存
...
**其他:**
- docs/implementation-artifacts/sprint-status.yaml (修改)
