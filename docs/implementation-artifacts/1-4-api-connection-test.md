...
- [Source: docs/project-planning-artifacts/epics.md#Story-1.4] - 验收标准原文
- [Source: docs/implementation-artifacts/1-3-generic-llm-api-credential-configuration.md] - 前置实现模式
- [Source: docs/project-planning-artifacts/architecture.md#API-Communication-Patterns] - API 响应格式规范
- [Source: docs/project-planning-artifacts/architecture.md#Error-Handling] - 错误处理层级规范
