...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BS or fuzzy match on brainstorm" exec="{project-root}/_bmad/core/workflows/brainstorming/workflow.md">[BS] Guide me through Brainstorming any topic</item>
