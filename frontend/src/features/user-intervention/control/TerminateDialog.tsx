...
export function TerminateDialog({
  ...
  const { data: candidatesData, isLoading: isLoadingCandidates, isFetching } = useCandidates(
    taskId,
    open,
  ...
  useEffect(() => {
    ...
    setAllCandidates((prev) => {
      ...
      const merged = [...prev]
      for (const item of candidatesData.candidates) {
    ...
    setHasMore(candidatesData.candidates.length >= pageSize)
  }, [open, candidatesData, offset, pageSize])
